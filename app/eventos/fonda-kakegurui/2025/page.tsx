...
export default async function FondaKakegurui2025Page() {
  ...
  const heroDescripcion = obtenerContenido(
    contenido,
    "hero_descripcion",
    "La primera edición de Fonda Kakegurui, una jornada de juegos, competencia y celebración de Fiestas Patrias organizada por Gonza."
  );

  const historia1 = obtenerContenido(
    contenido,
    "historia_1",
    "Esta edición fue organizada por Gonza y contó con varios juegos y actividades para celebrar las Fiestas Patrias."
  );

  const historia2 = obtenerContenido(
    contenido,
    "historia_2",
    "A diferencia de otras competencias, los juegos no tuvieron puntajes generales. La excepción fue el torneo de emboque, que tuvo su propio sistema de clasificación y una final para determinar al ganador."
  );

  const historia3 = obtenerContenido(
    contenido,
    "historia_3",
    "Con nueve participantes, la competencia se dividió inicialmente en tres grupos de tres personas. Quienes ganaban cada grupo avanzaban a la gran final."
  );

  const torneoDescripcion = obtenerContenido(
    contenido,
    "torneo_descripcion",
    "Nueve participantes. Tres grupos. Tres ganadores. Una final para definir al campeón."
  );

  const finalTitulo = obtenerContenido(
    contenido,
    "final_titulo",
    "LOS TRES FINALISTAS"
  );

  const podioDescripcion = obtenerContenido(
    contenido,
    "podio_descripcion",
    "Así terminó el torneo de emboque de Fonda Kakegurui 2025."
  );

  const campeonDescripcion = obtenerContenido(
    contenido,
    "campeon_descripcion",
    "Ganador del primer torneo de emboque de Fonda Kakegurui."
  );

  const momentoTitulo = obtenerContenido(
    contenido,
    "momento_titulo",
    "LA PUERTA DE CAMILO"
  );

  const momentoDescripcion = obtenerContenido(
    contenido,
    "momento_descripcion",
    "Toda edición tiene sus momentos memorables. Esta tuvo uno que merece una disculpa pública."
  );

  const momentoTituloFinal = obtenerContenido(
    contenido,
    "momento_titulo_final",
    "Perdón, Camilo."
  );

  const momentoDescripcionFinal = obtenerContenido(
    contenido,
    "momento_descripcion_final",
    "Públicamente queremos pedirle disculpas a Camilo por agujerear su puerta :c"
  );
  ...
  const grupos: Grupo[] = [
    {
      ...
      participantes: [
        obtenerContenido(
          contenido,
          "grupo_01_participante_1",
          "Camilo"
        ),
        obtenerContenido(
          contenido,
          "grupo_01_participante_2",
          "Angelo"
        ),
        obtenerContenido(
          contenido,
          "grupo_01_participante_3",
          "Seba Martínez"
        ),
      ],
      camposParticipantes: [
    ...
    },
    {
      ...
      participantes: [
        obtenerContenido(
          contenido,
          "grupo_02_participante_1",
          "Seba Silva"
        ),
        obtenerContenido(
          contenido,
          "grupo_02_participante_2",
          "Javier"
        ),
        obtenerContenido(
          contenido,
          "grupo_02_participante_3",
          "Ricardo"
        ),
      ],
      camposParticipantes: [
    ...
    },
    {
      ...
      participantes: [
        obtenerContenido(
          contenido,
          "grupo_03_participante_1",
          "Gonza"
        ),
        obtenerContenido(
          contenido,
          "grupo_03_participante_2",
          "Fefi"
        ),
        obtenerContenido(
          contenido,
          "grupo_03_participante_3",
          "Jeimy"
        ),
      ],
      camposParticipantes: [
      ...
      <div className="relative z-10">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24">
            ...
            <div className="text-center">
              ...
              <div className="relative mx-auto mt-5 max-w-2xl">
                <EditarTextoEdicion
                  valor={torneoDescripcion}
                  campo="torneo_descripcion"
                  edicionId={edicion.id}
                  multilinea
                      ...
                      (participante, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {esGanador && (
                              <span className="ml-3 shrink-0 text-xs font-bold uppercase tracking-widest text-violet-400">
                                GANADOR
                              </span>
                            )}
            ...
            <div className="mx-auto mt-12 max-w-4xl rounded-3xl border border-violet-500/30 bg-violet-950/30 p-10 text-center">
              ...
              <div className="relative mt-4">
                <EditarTextoEdicion
                  ...
                  campo="final_titulo"
                  edicionId={edicion.id}
                  claseTexto="text-4xl font-black"
                />
              </div>
              ...
              <div className="mt-10 grid gap-4 md:grid-cols-3">
                ...
                {finalistas.map((finalista) => (
                  ...
                  >
                    ...
                    <div className="relative mt-2">
                      <EditarTextoEdicion
                        valor={finalista.nombre}
                        campo={finalista.campo}
                        edicionId={edicion.id}
                        claseTexto="text-xl font-bold"
                      />
                    </div>
        ...
        <section className="mx-auto max-w-4xl px-6 py-28 text-center">
          ...
          <div className="relative mx-auto mt-8">
            <EditarTextoEdicion
              valor={momentoDescripcion}
              campo="momento_descripcion"
              edicionId={edicion.id}
              multilinea
              claseTexto="text-lg leading-8 text-zinc-300"
            />
          ...
          <div className="mx-auto mt-10 rounded-3xl border border-white/10 bg-zinc-900/90 p-10">
            ...
            <div className="relative">
              <EditarTextoEdicion
                valor={momentoTituloFinal}
                campo="momento_titulo_final"
                edicionId={edicion.id}
            ...
            <div className="relative mt-5">
              <EditarTextoEdicion
                valor={momentoDescripcionFinal}
                campo="momento_descripcion_final"
                edicionId={edicion.id}
                multilinea
                claseTexto="text-xl text-zinc-400"
              />
            </div>
